...
public class UserReg extends MyAsyncTask{
    private CheckInternet checkInternet;
    private User user;
    public UserReg(User user, CheckInternet checkInternet, MyResponseCallback callback)
    {
    ...
    protected String doInBackground(Void... voids){
        ...
        try{
            Connection.Response response = Jsoup.connect("https://bloop-me.ru/student/api/user/create")
